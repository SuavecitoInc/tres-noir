...
export type CartFragmentFragment = (
  ...
  & { buyerIdentity: (
    Pick<StorefrontTypes.CartBuyerIdentity, 'email'>
    & { customer?: StorefrontTypes.Maybe<Pick<StorefrontTypes.Customer, 'id'>> }
        ...
        & { attributes: Array<Pick<StorefrontTypes.Attribute, 'key' | 'value'>>, merchandise: (
          ...
          & { price: Pick<StorefrontTypes.MoneyV2, 'amount' | 'currencyCode'>, compareAtPrice?: StorefrontTypes.Maybe<Pick<StorefrontTypes.MoneyV2, 'amount' | 'currencyCode'>>, product: Pick<StorefrontTypes.Product, 'handle' | 'title' | 'productType'>, image?: StorefrontTypes.Maybe<Pick<StorefrontTypes.Image, 'url' | 'altText'>> }
