...
// @ts-ignorets
import text from "./safety-glasses-text.json"

type LensCustomization =
  | {
      type: "description"
      title: string
      description: string
    ...
    <Layout>
      ...
      <Page>
            ...
            <div className="row wrapper">
              ...
              <div className="col">
                <div className="color-wrapper lists">
                  {text.lensCustomizations.map(
                    (list: LensCustomization, index: number) => (
        ...
        <section className="what-you-get">
          ...
          <div className="wrapper">
            <StaticImage
              src="../../images/SafetyPouchCloth.jpg"
